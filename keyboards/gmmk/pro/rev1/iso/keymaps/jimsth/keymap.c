...
//      Ct_L            Win_L      Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left           Down          Right
    ...
    [_BASE] = LAYOUT(
        ...
        TT(_LOWER),     KC_A,      KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,                      KC_HOME,
    ...
    [_FN1] = LAYOUT(
        ...
        _______,        _______,   RGB_VAI, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______, 	                            _______,
        KC_CAPS,        _______,   RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                      KC_PGUP,
        _______,        _______,   RGB_NITE,RGB_HUI, _______, _______, _______, KC_NLCK, _______, RGB_TOD, RGB_TOI, _______,          _______,       RGB_MOD,       KC_PGDN,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,        KC_HOME,   KC_UP,   KC_END,  KC_PGUP, _______, KC_TAB,  KC_P4,   KC_P5,   KC_P6,   KC_PDOT, _______, _______,                               _______,
        _______,        KC_LEFT,   KC_DOWN, KC_RGHT, KC_PGDN, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_NO,   KC_PAST, _______, KC_PENT,                      KC_PGUP,
        _______,        _______,   KC_NO,   _______, _______, KC_NO,   KC_NO,   KC_NO,   KC_P0,   KC_00,   KC_PDOT, KC_PSLS,          _______,       RCTL(KC_PGUP), KC_PGDN,
...
const uint16_t PROGMEM rsft_up_pgup[] = { KC_RSFT, KC_UP, COMBO_END};
const uint16_t PROGMEM rsft_down_pgdn[] = { KC_RSFT, KC_DOWN, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
  [RSFT_UP_PGUP] = COMBO(rsft_up_pgup, KC_PGUP),
  [RSFT_DOWN_PGDN] = COMBO(rsft_down_pgdn, KC_PGDN),
