...
*/
	...
	// Note: Many advanced functions referenced in this file are defined in /users/jimsth/jimsth.c
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |=============================================================================================================|
     * | ISO  |  1 ! |  2 @ |  3 # |  4 $ |  5 % |  6 ^ |  7 & |  8 * |  9 ( |  0 ) |  - _ |  = + |  Backspc || Ins  |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+----------++------|
     * |   Tab   |  Q   |  W   |  E   |  R   |  T   |  Y   |  U   |  I   |  O   |  P   | [ }  | ] }  |       || Del  |
     * |---------+------+------+------+------+------+------+------+------+------+------+------+------+       ++------|
     * |  Capslock  |  A   |  S   |  D   |  F  |  G   |  H   |  J   |  K   |  L   | ; :  | ' "  | ISO| Enter || Home |
     * |------------+------+------+------+-----+------+------+------+------+------+------+------|----+========+------|
    ...
    [_BASE] = LAYOUT(
        ...
        CAPSNUM, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,           KC_HOME,
     ...
     * |------------+------+------+------+-----+------+------+------+------+------+------+------|----+========+------|
     * |  ____ |QK_BOOT |RGBNIT| ___ | ___ | ____ | ____ |NumLk | ____ | ____ |DOTCOM| CAD  | ______ ||RGBMOD|| ____ |
     * |--------------+------+------+------+------+------+------+------+------+------+------+--+=====++------++======|
    ...
    [_FN1] = LAYOUT(
        ...
        PRNCONF, TG_CAPS, TG_PAD,  TG_ESC,  TG_DEL,  TG_TDCAP,TG_ENC,  TG_INS,TG_SPCMOD,TG_AUTOCR,TG_ENGCAP,RGB_TOD, RGB_TOI, QK_BOOT,             RGB_TOG,
...
*/
    ...
    case _NUMPADMOUSE:
        ...
        if (user_config.rgb_hilite_numpad) {
            ...
            rgb_matrix_set_color(LED_DEL, RGB_CHARTREUSE);
            rgb_matrix_set_color(LED_HOME, RGB_CHARTREUSE);
...
//            rgb_matrix_set_color(LED_PGDN, RGB_CHARTREUSE);
    ...
    case _MOUSEKEY:
        ...
        rgb_matrix_set_color(LED_DEL, RGB_OFFBLUE);
        rgb_matrix_set_color(LED_HOME, RGB_OFFBLUE);
